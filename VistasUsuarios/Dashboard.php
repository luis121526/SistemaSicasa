  ...
  <nav>
    <a href="#0" aria-label="forecastr logo" class="logo">-->
     <!-- <svg width="140" height="49">
      ...
      <!--
      <center><img src="../img/favicon.ico" height="90" width="90"></center>
    </a>
    ...
    <ul class="admin-menu">
      <li class="menu-heading">
        <h3><?php //echo "$_SESSION[logueo]";   ?></h3>
      </li>
      <li>
        <a href="../VistasAdministrador/Dashboard.php">
          <svg>
      ...
      <li>
        <a href="#0">
          ...
          <span>Reportes (Incidencias)</span>
        </a>
      </li>
      <li>
        <a href="../VistasAdministrador/Usuarios.php">
          <svg>
      ...
      <li>
        <a href="../VistasAdministrador/Inventarios.php">
          <svg>
...
<section class="page-content">
  <section class="search-and-user">
    <div class="admin-profile">
      <span class="greeting"><?php //echo "Hola $_SESSION[logueo]" ?></span>
      <div class="notifications">-->
        <!--<svg>
          <use xlink:href="#users"></use>
        </svg>-->
        <?php 
        //<img src="../img/favicon.ico" height="90" width="90"> 
		/* $r=mysqli_query($conexion,"SELECT nombre,img_perfil FROM usuarios WHERE nombre_usuario ='$persona'"); 
    ...
    /*
       	...
       	?>
       	<!--<img src="data:image/jpeg; base64 ,<?php //echo $imagen ?> " width="60" height="60" class="img-fluid">
       </div>
    </div>
  </section>-->
  <body>
